...
import json
import random
""" Print a tip from list of pragmatic programmer tips"""
...
PRAGTIPS = """
{
	...
	"Don’t Program by Coincidence": "Rely only on reliable things. Beware of accidental complexity, and don’t confuse a happy coincidence with a purposeful plan. This engenders superstitions.",
...
"""
tips = json.loads(PRAGTIPS)
tip = random.sample(tips.items(), 1)[0]
print("{} - {}".format(tip[0], tip[1]))
